...
contract BCCoin is Interface {// Inheriting the interface requires implementing all the functions inside the interface.
    ...
    function transfer(address _to, uint256 _value) public {
        ...
        // makes sure message sender balance has the value he wants to transfer.
    ...
    function transferFrom(address _from, address _to, uint256 _value) public {
        ...
        // the value that the message sender is allowed to spend from the _from account.
    ...
    function getTokens() public payable {
        ...
        transferFrom(Owner, msg.sender, _tokensNo);
    }
    ...
    // ------------------------------------------------------------------------
    function allowance(address tokenOwner, address _spender) public view returns (uint remaining) {
